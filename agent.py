...
class Agent(object):
	def __init__(self,layers,batch,explore,explore_l,explore_d,learning,decay,path, load_filename, is_continue_train = False):
		...
		if is_continue_train:
			self.Q.recover(self.directory, load_filename)
			# self.Q.initialize_continue()
		else:
			self.Q.initialize()
